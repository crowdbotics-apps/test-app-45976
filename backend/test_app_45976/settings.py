"""
Django settings for test_app_45976 project.
...
ROOT_URLCONF = 'test_app_45976.urls'
...
WSGI_APPLICATION = 'test_app_45976.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app_45976 API",
    "DESCRIPTION": "API documentation for test_app_45976 App",
    "VERSION": "v1",
}
